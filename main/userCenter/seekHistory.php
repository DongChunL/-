...
$accountType = "支付";
$sql = "SELECT * FROM accounts  where user_name='$username'and accountType ='$accountType 'order by  created_at desc";
...
//page = 3 limit 6
/*用户名*/
$sql = "select * from accounts where user_name='$username'and accountType ='$accountType' AND (user_name like '%$keyword%' or moneyIn like '%$keyword%') order by  created_at desc limit {$limitFrom}, {$limitNews}";
$sqlCount = "select count(*) from accounts where user_name='$username'and user_name like '%$keyword%' or moneyIn like '%$keyword%'";
...
<fieldset id="manageUser" style="height:680px;width: 900px;">
    <legend style="font-size: 24px;color: #666;">消费记录</legend>
    <style>
    ...
    <form method="get" action="mySpendAccount.php" class="newsForm" style="margin:10px;text-align: center">
    ...
    <div class="commentBox" style="min-height:300px;width900px" >
        <?php
        $count = 0;
        ...
        <div class="oneComment" style="width: 860px; height: 50px;">
            ...
            <?php  endwhile;?>
            <div class="oneComment">共<?php echo $count;?>条用户充值记录</div>
        </div>
</fieldset>
</body>
</html>
