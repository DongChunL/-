...
$sql = "SELECT * FROM comment  WHERE commentWho='$username' order by  commentTime desc";
...
//page = 3 limit 6
/*用户名*/
$sql = "select * from comment where commentWho='$username'AND (commentWho like '%$keyword%' or commentTime like '%$keyword%' or commentWhat like '%$keyword%')order by  commentTime desc limit {$limitFrom}, {$limitNews} ";
$sqlCount = "select count(*) from comment where commentWho='$username' AND (commentWho like '%$keyword%' or commentTime like '%$keyword%'  or commentWhat like '%$keyword%')";
...
<fieldset id="manageUser" style="height:680px;width: 900px;">
    ...
    <form method="get" action="myComment.php" class="newsForm" style="margin:10px;text-align: center">
