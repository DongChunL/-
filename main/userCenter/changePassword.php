...
<div class="setPassword">
    ...
    <table>
        <tr>
            <td><span style="font-size: 20px;color: black;font-weight: bold">原密码</span></td><span class="tipOld"></span>
        </tr>
    <tr><td><input type="password" style="height: 30px;"name="oldPassword" id="oldPassword"></td></tr>
        <tr>
            <td><span style="font-size: 20px;color: black;font-weight: bold">新密码</span></td>
        </tr>
    <tr><td><input type="password" style="height: 30px;"name="newPassword" id="newPassword"></td></tr>
        <tr>
            <td><span style="font-size: 20px;color: black;font-weight: bold">确认密码</span></td>
        </tr>
        <tr><td><input type="password" style="height: 30px;"name="confirmPassword" id="confirmPassword"></td></tr>

        <tr>
            <td><input type="submit" name="submit" class="submit" value="提交" style="width: 50px;height: 30px;"onclick="passwordIsEqual()"></td>
        </tr>
        <?php
        session_start();
