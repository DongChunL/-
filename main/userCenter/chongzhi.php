...
/*    echo "第一次充值";*/
    echo "<script>window.location.href='user_index.php#myCoins';</script>";
    exit();
}
...
echo "<script>window.location.href='user_index.php#myCoins';/*            window.event.returnValue=true*/</script>";
