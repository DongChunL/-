...
<fieldset id="manageUser" style="margin-top:10px;width: 1100px;">
    <legend style="font-size: 24px;color: #666;margin-left: 10px;">发布出租信息</legend>
    ...
    <div class="mainBorder" style="float:left">
        <table class="borderTxt" width="100%" height="49" cellspacing="0" cellpadding="0" border="0">
            <tbody><tr>
                ...
                <td width="72%" style="font-size: 16px;">
                    基本信息
                </td>
            </tr>
            </tbody></table>
