...
if(isset($_GET['publicId'])){
    ...
    $publicClass  =$result['publicClass'];
    $publicSheng  =$result['publicSheng'];
    $publicShi =$result['publicShi'];
    $publicQu  = $result['publicQu'];
    $publicAddress =$result['publicAddress'];
    $publicMoney =$result['publicMoney'];
    $publicMoneyStyle =$result['publicMoneyStyle'];
    $publicPledge  =$result['publicPledge'];
    $publicMinRentTime 	 = $result['publicMinRentTime'];
    $publicDemand =$result['publicDemand'];
    $publicDescribe =$result['publicDescribe'];
    $publicPerson =$result['publicPerson'];
    $publicMPhone =$result['publicMPhone'];
    $publicGPhone = $result['publicGPhone'];
    $publicQQ = $result['publicQQ'];
    $timeToPublic = $result['timeToPublic'];
...
<body>
<form method="post" action="publicSuccess.php" id="form1" enctype="multipart/form-data">

    <input type="hidden" name="toSuccess" value="updatePublic">
    <input type="hidden" name="timeToPublic" value="<?php echo date('Y-m-d h:i:s', time());?>">

    <input type="hidden" name="publicId" id="publicId" value="<?php echo $publicId;?>">
    <input type="hidden" id="publicClass" value="<?php echo $publicClass;?>">
    <input type="hidden" id="publicMoneyStyle" value="<?php echo $publicMoneyStyle;?>">
    <input type="hidden" id="publicMinRentTime" value="<?php echo $publicMinRentTime;?>">
    <input type="hidden" id="publicDemand" value="<?php echo $publicDemand;?>">
    <!--头部-->
    <!--导航-->
    <div class="mainBorder" style="float:left">
        ...
        <table width="96%" cellspacing="0" cellpadding="0" border="0" align="center">
            <tbody><tr>
                ...
                <td>
                    <strong id="CurKind">自行车&gt;</strong><select name="classStyle" id="classStyle">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <td style="height: 24px">
                                &nbsp;<input name="TitleBox" maxlength="30" id="TitleBox" size="44" onfocus="checkTitle1()" value="<?php echo $publicTitle;?>" onblur="this.value=this.value.replace(/(^\s*)|(\s*$)/g,'');checkTitle()" type="text">
                            </td>
                            <td style="height: 24px">
            ...
            <tr>
                ...
                <td width="83%">
                    <div id="divCity" style="float: left;">
                        <div id="UpdatePanel1">
                            省：<select id="provinces" name="provinces"></select>
...
//遍历json数据，组装下拉选框添加到html中
            ...
            <tr>
                ...
                <td>
                    <input name="address"type="text" placeholder="填写街道门牌号" value="<?php  echo $publicAddress?>"><span>(选填)</span>
                </td>
            </tr>
            <tr>
                <td height="32" align="right">
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <td>
                                &nbsp;<input name="RentMoneyBox" maxlength="6" id="RentMoneyBox"value="<?php echo $publicMoney?>" onfocus="checkRentMoney1()" onblur="checkRentMoney()" style="width:90px;" type="text">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <td style="height: 23px">
                                &nbsp;<input name="DepositBox" maxlength="5" value="<?php echo $publicPledge?>" id="DepositBox" onfocus="checkDepositMoney1()" onblur="checkDepositMoney()" style="width:90px;" type="text">
                                &nbsp;元
            ...
            <tr id="mao2">
                ...
                <td>
                    <textarea name="txtContent" rows="2" cols="20" id="txtContent" onfocus="inputfocus(this)" onblur="inputblur();" style="height:180px;width:755px;color: #666;"><?php echo $publicDescribe?> </textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="87%">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <td style="height: 23px">
                                &nbsp;<input name="RelationMan" value="<?php echo $publicPerson;?>" maxlength="4" size="20" id="RelationMan" onfocus="my('divRelationMan').style.display='block'" onblur="checkRelationMan()" style="width:80px;" type="text">
                            </td>
                            <td style="height: 23px">
                ...
                <td>
                    <table>
                        <tbody><tr>
                            <td>
                                <div id="spanPhone">
                                    <input name="AreaCodeBox" maxlength="4" value="<?php echo substr($publicGPhone,0,3) ?>" size="8" id="AreaCodeBox" style="width:30px;" type="text">
                                    -
                                    <input name="PhoneBox" maxlength="8" size="20" value="<?php echo substr($publicGPhone,2,8) ?>" id="PhoneBox" style="width:70px;" type="text">
                                    -
                                    <input name="ExtensionBox" maxlength="4" size="8" value="<?php echo substr($publicGPhone,10,3) ?>" id="ExtensionBox" style="width:30px;" type="text"></div>
                            </td>
                            <td>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <td>
                                &nbsp;<input name="MobileBox" value="<?php echo $publicMPhone;?>" maxlength="11" size="20" id="MobileBox" onfocus="my('divPhone').style.display='block'" onblur="checkPhone()" style="width:156px;" type="text">
                            </td>
                            <td>
                                <div id="divPhone">
                                </div>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody><tr>
                            <td>
                                &nbsp;<input name="QQBox" value="<?php echo $publicQQ;?>" maxlength="10" id="QQBox" onfocus="my('divQQ').style.display='block'" onblur="checkQQ()" style="width:156px;" type="text">
                            </td>
                            <td>
                                <div id="divQQ">
                                </div>
    ...
    <script>
        (function(){
            var publicClass = document.getElementById('publicClass').value;
            var publicMoneyStyle = document.getElementById('publicMoneyStyle').value;
            var publicMinRentTime = document.getElementById('publicMinRentTime').value;
            var publicDemand = document.getElementById('publicDemand').value;
            document.getElementById('classStyle').value = publicClass;
            document.getElementById('RentMoneyStyle').value = publicMoneyStyle;
            document.getElementById('ddlZuQi').value = publicMinRentTime;
            document.getElementById('ddlPayReq').value = publicDemand;
        })();
    </script>
</body>
</html>