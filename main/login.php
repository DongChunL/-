...
<div class="login_bg">
    <div class="login_logo">
        0<h1>自  行  车  租  赁  网</h1>+6

    </div>
    <fieldset>
        <legend>骑行伴你好心情！</legend>
        <form action="Success.php" method="post" class="form1" onsubmit="checkLogin()">
            <input type="hidden" name="checkInfo" value="login">
            <table>
                <tr>
                    <td class="tdFloat "><img src="../image/icons/user.png" class="user_img"alt=""><input type="text"  placeholder="用户名/手机号/邮箱" name="username" id="username" onblur="checkname()"><span id="tipUserName"></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td   colspan="2" class="srButton"><input type="submit" name="submit1" id="submit" value="登录" /><br><input type="button" name="register" id="register" value="注册" onclick="window.location.href='register.html'"/></td>
                </tr>
            </table>
            <div class="aside"><a href="../User/pwd.php">·找回密码·</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../User/pwd.html">·修改密码·</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../index.php">·游客登录·</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="adminLogin.php" title="后台管理">·后台管理·</a></div>
        </form>
    </fieldset>
</div>
<script>
