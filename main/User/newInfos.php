...
$limitNews = 4; //每页显示新闻数量, 这里设置每页显示3条新闻
        ...
        <div class="bodyMid">
            <div class="midLeft">
                <div class="newsCon_border">
                    <h5 id="newstitle"><a href="../../index.php">首页</a>&gt;&gt;<a href="newInfos.php">租赁资讯</a></h5>
                    <!--数据部分-->
                    <?php while($arr=mysqli_fetch_array($result)):?>

                    <div class="newTitle">
                        <a href="news.php?id=<?php echo $arr['id'];?>" title="<?php echo $arr['title'];?>" target="_blank">
                            <?php echo $arr['title'];?>
                        </a>
                    </div>
                    <div class="newsDate">
                    ...
                    <div class="newsCon clear">
                        ...
                        {echo $arr['content'];}
                        ?><a href="news.php?id=<?php echo $arr['id'];?>" target="_blank">[阅读全文]</a>
                    </div>
                    <div class="newsFoor">
